   			 	...
   			 	foreach($roles as $role)
   			 		{ 
   			 			if($currentRole == $role['roleID'])
			   				...
			   				<li class="active"><a href="#"><?php echo $role['roleName'];?> <span class="sr-only">(current)</span></a></li>

			   		<?php   }

			   			else
			   			{ ?>
							<li class="disabled"><a href="#"><?php echo $role['roleName'];?><span class="sr-only"></span></a></li>
							<?php
			   			}
			   		}
			   			?>
